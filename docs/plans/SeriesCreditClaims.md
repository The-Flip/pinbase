...
- **Ingest writes `Credit(series=...)` rows directly** at [ingest_pinbase.py:1397](../../backend/apps/catalog/management/commands/ingest_pinbase.py#L1397). No `Claim`, no `ChangeSet`, no provenance.
...
Symmetric to MachineModel credits. Claim keying at ingest follows the existing pattern in [ingest_pinbase.py:1848-1866](../../backend/apps/catalog/management/commands/ingest_pinbase.py#L1848-L1866):
...
1. **Rewrite the Series-credit ingest path.** [ingest_pinbase.py:1380-1407](../../backend/apps/catalog/management/commands/ingest_pinbase.py#L1380-L1407): replace the direct `Credit(series=...)` bulk_create with claim assertion, mirroring the MachineModel credit block at [ingest_pinbase.py:1848-1866](../../backend/apps/catalog/management/commands/ingest_pinbase.py#L1848-L1866). Uses the same `build_relationship_claim("credit", ...)` helper.
