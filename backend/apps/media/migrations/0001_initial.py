    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                name="media_mediavariant_role_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="mediavariant",
            constraint=models.CheckConstraint(
                ...
                name="media_mediavariant_storage_key_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="mediavariant",
            constraint=models.CheckConstraint(
                condition=models.Q(("mime_type", ""), _negated=True),
                name="media_mediavariant_mime_type_not_blank",
            ),
        ),
        migrations.AddConstraint(
            model_name="mediavariant",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("storage_key__startswith", "http://"), _negated=True),
                    models.Q(("storage_key__startswith", "https://"), _negated=True),
                ),
        ...
        migrations.AddConstraint(
            model_name="mediavariant",
            constraint=models.CheckConstraint(
                condition=models.Q(("storage_key__contains", ".."), _negated=True),
        ...
        migrations.AddConstraint(
            model_name="mediavariant",
            constraint=models.CheckConstraint(
                condition=models.Q(("storage_key__regex", "^\\S+$")),
        ...
        migrations.AddConstraint(
            model_name="mediavariant",
            constraint=models.UniqueConstraint(
                fields=("asset", "role"), name="media_mediavariant_unique_asset_role"
            ),
        ),
    ]
